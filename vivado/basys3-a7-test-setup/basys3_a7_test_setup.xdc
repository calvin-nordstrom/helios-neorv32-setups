...
#set_property PACKAGE_PIN V16 [get_ports {gpio_o[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[1]}]
#set_property PACKAGE_PIN W16 [get_ports {gpio_o[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[2]}]
#set_property PACKAGE_PIN W17 [get_ports {gpio_o[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[3]}]
#set_property PACKAGE_PIN W15 [get_ports {gpio_o[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[4]}]
#set_property PACKAGE_PIN V15 [get_ports {gpio_o[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[5]}]
#set_property PACKAGE_PIN W14 [get_ports {gpio_o[6]}]
...
#set_property PACKAGE_PIN V2 [get_ports {gpio_o[8]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[8]}]
#set_property PACKAGE_PIN T3 [get_ports {gpio_o[9]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[9]}]
#set_property PACKAGE_PIN T2 [get_ports {gpio_o[10]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[10]}]
#set_property PACKAGE_PIN R3 [get_ports {gpio_o[11]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[11]}]
#set_property PACKAGE_PIN W2 [get_ports {gpio_o[12]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[12]}]
#set_property PACKAGE_PIN U1 [get_ports {gpio_o[13]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[13]}]
#set_property PACKAGE_PIN T1 [get_ports {gpio_o[14]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_o[14]}]
#set_property PACKAGE_PIN R2 [get_ports {gpio_o[15]}]
...
set_property BITSTREAM.CONFIG.SPI_B{gpio_oIDTH 4 [current_design]
